...
class ImageHandler:
    ...
    def load_image_from_file(self, image_path: str) -> np.asarray:
        ...
        return image_array.astype(dtype=np.uint16)

    def load_ref_image_from_file(self, image_path: str) -> None:
        self.reference_image = self.load_image_from_file(image_path)

    def load_mod_image_from_file(self, image_path: str) -> None:
        self.modified_image_copy = self.load_image_from_file(image_path)
        self.modified_image = copy.deepcopy(self.modified_image_copy)
